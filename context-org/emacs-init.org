...
#+title: Emacs Config
#+PROPERTY: header-args:emacs-lisp :tangle ../chezmoi/dot_emacs.d/init.el :mkdirp yes

* early-init
#+begin_src emacs-lisp  :tangle ../chezmoi/dot_emacs.d/early-init.el
...
- https://emacs.stackexchange.com/questions/66382/how-to-set-the-default-indentation-width-globally
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f12>") 'open-zv-initial-file)
  ;;; make ecs quit prompt
...
** hydra-general 
:PROPERTIES:
:ID:       521a3924-1c7d-4c4d-a4ad-37d596eb4a35
:END:
#+begin_src emacs-lisp
...
** COMMENT keycast
#+begin_src emacs-lisp
  ;; https://github.com/seagle0128/.emacs.d/issues/27
  ;;; M-x all-the-icons-install-fonts
  ;;; 需要执行该命令，安装相关字体库,
  ;;; https://github.com/domtronn/all-the-icons.el
  ;;; 查看 all-the-icons 包，可以直接下载对应的字体库到机器的指定位置
  ;;; manjaro :  /home/zv-.local/share/fonts
...
- https://emacsworld.com/packages/2023/07/14/splitting-windows-in-emacs-with-golden-ratio.html
...
#+end_src
** conf-mode
- https://emacs.stackexchange.com/questions/33664/how-can-you-make-conf-mode-indent-with-tabs
#+begin_src emacs-lisp
...
#+end_src
** COMMENT origami-mode
- https://emacs.stackexchange.com/questions/71463/activate-origami-folding-for-python-only-with-using-use-package
- https://github.com/gregsexton/origami.el
#+begin_src emacs-lisp
  (use-package  origami
    :config
    (add-hook 'emacs-lisp-mode-hook 'origami-mode)
    (add-hook 'graphviz-dot-mode-hook 'origami-mode)
    ;; :hook (emacs-lisp-mode . origami-mode)
    ;; :hook (graphviz-dot-mode . origami-mode)
  )
...
#+end_src
** bable
- https://stackoverflow.com/questions/61390513/how-can-i-add-attr-html-around-results-preview-output-of-source-block-in
