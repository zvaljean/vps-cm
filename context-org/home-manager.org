...
#+title: Nix Config
#+PROPERTY: header-args:nix :tangle ../chezmoi/dot_config/home-manager/flake.nix :mkdirp yes

** flake nix
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/flake.nix :mkdirp yes
  {
...
*** home
**** default
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/home/default.nix :mkdirp yes
{ config, pkgs, ... }:
{
  imports = [
    ./env.nix 
...
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/home/env.nix :mkdirp yes
...
*** pkgs
**** default
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/default.nix :mkdirp yes
...
#+end_src
**** common tools
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/common/default.nix :mkdirp yes
...
#+end_src
**** fish
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/fish/default.nix :mkdirp yes
  { config, pkgs, lib, ... }:
  {
...
**** starship
***** nix
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/starship/default.nix :mkdirp yes
{ config, pkgs, ... }:
{
  home.packages = builtins.attrValues {
    inherit (pkgs)
...
***** config
#+begin_src toml :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/starship/starship.toml :mkdirp yes
...
**** tmux
***** nix
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/tmux/default.nix :mkdirp yes
    { config, pkgs, ... }:
    {
      _class = "homeManager";
...
**** zoxide
#+begin_src nix :tangle ../chezmoi/dot_config/home-manager/modules/pkgs/zoxide/default.nix :mkdirp yes
  { config, pkgs, lib, ... }:
  {
    _class = "homeManager";
    programs.zoxide = {
